...
defmodule Serum.CLI do
  ...
  defp task_map do
    providers =
      if in_project_dir?(),
        do: @main_task_providers,
        else: @main_task_providers ++ @proj_task_providers
  ...
  def usage() do
    ...
    if in_project_dir?() do
      IO.puts """
        ...
        You are currently in a valid Serum project directory.
        You can run these additional tasks:
      """
